 ...
 * @generated
 */
public class TestProjectV1Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TestProjectV1Package.PERFORMANCE_REVIEW: {
				PerformanceReview performanceReview = (PerformanceReview)theEObject;
				T result = casePerformanceReview(performanceReview);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TestProjectV1Package.ADMIN: {
				...
				if (result == null) result = caseEmployee(admin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestProjectV1Package.UML_STATE_MACHINE_COFFEE_VENDING_MACHINE: {
				UMLStateMachineCoffeeVendingMachine umlStateMachineCoffeeVendingMachine = (UMLStateMachineCoffeeVendingMachine)theEObject;
				T result = caseUMLStateMachineCoffeeVendingMachine(umlStateMachineCoffeeVendingMachine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Performance Review</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Performance Review</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePerformanceReview(PerformanceReview object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>UML State Machine Coffee Vending Machine</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>UML State Machine Coffee Vending Machine</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUMLStateMachineCoffeeVendingMachine(UMLStateMachineCoffeeVendingMachine object) {
		return null;
	}
